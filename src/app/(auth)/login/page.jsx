...
const login = () => {
  ...
  async function handleLoginFromUser(userInfo) {
    const getUserInfo = {
  ...
  async function handleLoginFromGoogle() {
    await signIn("google", {
      callbackUrl: "http://localhost:3000/todo-list",
    });
  }
  return (
    <section class="bg-gray-100 min-h-screen flex box-border justify-center items-center">
      <div class="bg-white rounded-2xl flex max-w-3xl p-5 items-center">
        <div class="md:w-1/2 px-8">
          ...
          <form action={handleLoginFromUser} class="flex flex-col gap-4">
            <input
